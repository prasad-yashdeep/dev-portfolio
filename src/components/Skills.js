...
<>
    ...
    >
        ...
        <Skill name="Python" x="-20vw" y="2vw" />
          ...
          <Skill name="AI Agents" x="15vw" y="-12vw" />
          <Skill name="Vision & NLP" x="-35vw" y="-5vw" />
          <Skill name="GPU & CUDA Computing" x="32vw" y="-5vw" />
          <Skill name="Deep Learning" x="0vw" y="-20vw" />
          <Skill name="Firebase" x="-25vw" y="18vw" />
          <Skill name="Docker& Kubernetes" x="28vw" y="18vw" />
    </div></>
  );
};
